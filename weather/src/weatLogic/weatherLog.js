        ...
        return (
            <>
                {info.map(({ time, summary, icon, sunriseTime, sunsetTime, temperatureHigh, temperatureLow }, i) => {
                    return <Render name={name} key={i} time={time} summary={summary} icon={icon} sunriseTime={sunriseTime} sunsetTime={sunsetTime} temperatureHigh={temperatureHigh} temperatureLow={temperatureLow} />
                })}
